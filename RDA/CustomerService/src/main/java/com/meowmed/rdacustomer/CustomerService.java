...
public class CustomerService {
    ...
    void setUp(){
        ...
        CustomerEntity Jan= new CustomerEntity("Jan", "Lorenz", "", "herr","ledig",birthdayOfJan,"student",adressJan , "+49123456789" ,"jan-niklas-johannes.lorenz@stud.hs-hannover.de" ,"DE43100500000920018963", false  );

        LocalDate birthdayofDaniel= LocalDate.of(2002,06,26);
        AddressEntity adressDaniel= new AddressEntity("Hannover", "Subway Hbf", "12345");
        CustomerEntity Daniel= new CustomerEntity("Daniel", "Arnold","","herr", "ledig", birthdayofDaniel, "student", adressDaniel, "+4942069123123", "daniel.arnold@stud.hs-hannover.de", "DE43100500000920018963", false);
        ...
        CustomerEntity Alex= new CustomerEntity("Alexander","Hampel","","herr","ledig",birthdayOfAlex,"student", adressAlex, "+49123456789", "alexander.hampel@stud.hs-hannover.de", "DE43100500000920018963", false);
