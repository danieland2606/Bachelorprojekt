...
| **ID** | **Name**                                                             | **Beschreibung**                                                                                                                                                  | **Priorität** | **Aufwandsschätzung** | **Sprint** | **Anmerkungen** | **Status** |
| ------ | -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------- | ---------- | --------------- | ---------- |
...
| 16     | Jahresdeckung nachträglich ändern                                    | Die Jahresdeckung von Verträgen soll im nachhinein über die GUI änderbar sein.                                                                                    | Hoch          |                       | 3          |                 |            |
...
| 18     | Team UI: Umzug auf das neue Framework                                | Team UI hat sich ein Web-Framework ausgesucht. In diesem Sprint soll das System darauf umziehen                                                                   | Hoch          |                       | 3          |                 |            |
| 19     | Team UI: Usability des "Versicherungspreis berechnen" Button erhöhen | Der Button zum berechnen des Versicherungspreises ist nicht sehr intuitiv. Das soll geändert werden                                                               | Hoch          |                       | 3          |                 |            |
| 20     | Team UI: Wahl eines Frontend Frameworks                              | Um die aufhübschung zu erleichtern soll ein Frontend Framework zur Hilfe gezogen werden, damit nicht alles per Hand gemacht werden muss                           | Hoch          |                       | 3          |                 |            |
| 21     | Team UI: Aufhübschung der UI                                         | Die UI soll etwas aufgehübscht werden, damit sie moderner aussieht                                                                                                | Hoch          |                       | 4          |                 |            |
...
| 24     | MeowMed Logo auf der Webseite                                        | Das Logo soll auf der Webseite erscheinen                                                                                                                         | Mittel        |                       | 4          |                 |            |
...
| 27     | Katzenwesen ändern                                                   | Bei Katzen soll nun auch das Wesen geändert werden                                                                                                                | Hoch          |                       | 4          |                 |            |
...
| 29     | Arbeitsstatus des Kunden ändern                                      | Beim Kunden soll der Arbeitsstatus änderbar sein                                                                                                                  | Hoch          |                       | 4          |                 |            |
